...
if (typeof window !== 'undefined') {
  ...
  window.onerror = function(message: string | Event, source: string | undefined, lineno: number | undefined, _colno: number | undefined, error: Error | undefined) {
    showError('CRASH DETECTED', String(message), `File: ${source}\nLine: ${lineno}\nStack: ${error?.stack}`);
    return false;
  };
