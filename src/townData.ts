...
export const reviews = {
  ...
  "swithland": {
    ...
    localSpice: 'Providing expert plumbing services across Swithland, specifically near Swithland Reservoir.'
  },
  "quorn": {
    name: 'Quorn',
    postcode: 'LE12',
    ...
    localSpice: 'Specialist repairs and installations near the Great Central Railway and Quorn Cross.'
  },
  "mountsorrel": {
    name: 'Mountsorrel',
    postcode: 'LE12',
    ...
    localSpice: 'Your local plumbing specialist near the historic Buttercross and Mountsorrel Quarry.'
  },
  "sileby": {
    name: 'Sileby',
    postcode: 'LE12',
    ...
    localSpice: 'Dedicated local experts serving residents near Sileby Mill and along the Brook.'
  },
  "barrow-upon-soar": {
    ...
    phone: '01509 447469',
    landmark: 'River Soar',
    localSpice: 'Serving the community from the banks of the River Soar to the home of the Barrow Kipper fossil.'
  },
  "woodhouse-eaves": {
    ...
    localSpice: 'Providing expert plumbing care in the heart of Charnwood Forest, just below Beacon Hill.'
  },
  "cossington": {
    name: 'Cossington',
    postcode: 'LE7',
    ...
    localSpice: 'Trusted plumbing partner for the quiet village of Cossington, near the nature reserve.'
  }
};