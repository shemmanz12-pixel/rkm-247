...
export const towns: Record<string, TownData> = {
  ...
  'measham': {
    ...
    authorityParagraphs: [
      ...
      "With a high density of rental properties in the town centre, we provide rapid legionella checksa and tenant emergency response services, ensuring DE12 7 properties remain compliant and safe."
    ]
  },
  'markfield': {
    name: "Markfield",
