...
const Careers: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-50 pt-24 pb-12 font-sans">
      <Helmet>
        <title>Apprentice Plumber Coalville | Training Register 2026</title>
        <meta name="description" content="Join the RKM Plumbing training register for our 2026 apprentice intake in Coalville & Ashby. Local specialists in central heating, leak detection, and 24/7 emergency plumbing." />
      ...
      <div className="container mx-auto px-4 max-w-4xl">
        ...
        <div className="mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <Link to="/plumber/coalville" className="group bg-white p-8 rounded-2xl border border-gray-100 hover:border-[#A6892C] hover:shadow-xl transition-all duration-300">
