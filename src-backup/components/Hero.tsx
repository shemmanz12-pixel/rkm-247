...
const Hero = ({ town, service }: HeroProps) => {
  const isLandingPage = !!town || !!service;
  const displayLocation = town ? town : "Leicestershire";
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="max-w-2xl">
            ...
            <h1 className="text-5xl lg:text-7xl font-black text-slate-900 leading-[1.05] mb-8 tracking-tight">
              LOCAL EMERGENCY <br/>
              PLUMBER {isLandingPage ? 'IN' : '&'} <br/>
              <span className="text-[#A6892C]">
                {isLandingPage ? displayLocation.toUpperCase() : 'HEATING SPECIALIST COALVILLE'}
              </span>
            </h1>
