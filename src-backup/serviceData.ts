// This file holds the text for your service pages
// KEYS UPDATED TO MATCH SERVICEPAGE NORMALIZER
export const serviceContent: Record<string, { title: string; heroText: string; description: string }> = {
  "local-plumber": {
